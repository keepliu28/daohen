...
import { View, Text, Textarea, ScrollView, Input, Picker, MovableArea, MovableView } from '@tarojs/components'
import Taro, { useDidShow } from '@tarojs/taro'
import { getEntries, saveEntry, deleteEntryById } from '../../utils/storage'
import './index.scss'
    ...
    <View className='app-container'>
      ...
      {(view === 'home' || view === 'calendar' || view === 'mood' || view === 'mood-detail') && (
        <View className='top-header'>
          {!isSearchMode ? (
            <><View className='icon-btn' onClick={() => { setIsDrawerOpen(true); triggerVibrate('light'); }}><Text>≡</Text></View>
